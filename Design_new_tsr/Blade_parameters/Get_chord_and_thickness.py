...
"""Changes include: increasing of TSR with new scale tsr"""
New_scale_tsr = 1.13

"""Keeping the maximum blade chord in line with DTU max chord -> reduction in weight"""
