...
# Input variables for the BB neo
tsr_rated = 7.79    # [-] This comes from the hawc2s results
R_BB = 91.5         # [m]
Cp_opt = 0.8      # [-] from hawc2s results
rho = 1.225         # [kg/m**3]
...
if __name__ == '__main__':
    ORIG_PATH = 'Assignment_3/_master/BB.htc'
    SAVE_HAWC2S_DIR = '.'
    ...
    htc.make_hawc2s_ctrltune(SAVE_HAWC2S_DIR,
                    ...
                    opt_path='./data/BB_compute_flex_opt_neo.opt',
                    compute_steady_states=True,
