...
if __name__ == '__main__':
    ...
    maximum_allowable_rotor_torque = 16.855e6 # [Nm]
    fname = f'Assignment_3/my_design/Part_2/res_hawc2s/BB_neo_ctrltune_{ctrl}_ctrl_tuning.txt'
    ctrltune_dict = load_ctrl_txt(fname)

    # Master & Save locations
    ORIG_PATH = 'Assignment_3/my_design/Part_3/_master/BB_neo.htc'
    SAVE_HAWC2S_DIR = 'Assignment_3/my_design/Part_3/htc'
