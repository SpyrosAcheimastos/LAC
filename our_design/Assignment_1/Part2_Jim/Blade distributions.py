...
DTU_10MW_file_original = 'DTU_10MW_RWT_our_design_ae.dat'# Update with your actual file path
...
fig2.tight_layout()
fig2.savefig('distribution_blade.pdf', dpi=300, bbox_inches='tight')
