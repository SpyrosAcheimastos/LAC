import numpy as np
from lacbox.aero import max_twist, min_tc_chord, root_chord
...
def get_design_functions_10MW(cl_scale=1.0):
    """Returns the design functions for Cl [-], Cd [-], AoA [deg] as a function of Relative profile thickness (t/c) [%] (0-100)

    This is for our design of the 10 MW Rotor
...
def single_point_design(
    ...
    CT = CT_fun(r, R, CLT)
    CP = CP_fun(r, R, CLP)
    return chord, tc, twist, cl, cd, aoa, a, CLT, CLP, CT, CP
