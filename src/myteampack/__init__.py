...
class MyHTC(HTCFile):
    ...
    def make_hawc2s(self, save_dir, rigid, append, opt_path,
                    opt_lambda, minpitch, genspeed=(0, 480), **kwargs):
        ...
        self.hawcstab2.operational_data.min_pitch = minpitch
    ...
    def make_step(self, save_dir, append, wsp_start, wsp_stop, t_start, t_stop, t_step, ctrltune_dict,
                  scale_time_start=100, **kwargs):
        """
        ...
        for i in range(wsp_start, wsp_stop):
            ...
            t_1 = t_0 + 1
            wsp_tmp = wsp_tmp + 1
            self.wind.add_line(name='wind_ramp_abs', values=[t_0, t_1, V_0, V_1],
                               comments=f'wsp after the step: {wsp_tmp}')
